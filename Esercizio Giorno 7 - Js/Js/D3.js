...
characters = characters.filter(str => {
  for (let obj of femaleCharacters) {
    if (obj.name === str) {
      return false;
    }
  }
...
let randomObject = getRandomElement(starWarsCharacters);

console.log("Questo personaggio ha le seguenti proprietà:");
